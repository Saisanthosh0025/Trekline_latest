...
// Function to fetch data from the "emergency" table
...
<head>
    ...
    <title>TrekLine | Emergency Data</title>
    <style>
        .sidebar {
            width: 250px;
            position: fixed;
...
<div class="content">
    <h2>Emergency Request From Client's </h2>

    <?php if (empty($emergencyData)) { // Check if there is no data ?>
        <p>No emergency data is found.</p>
