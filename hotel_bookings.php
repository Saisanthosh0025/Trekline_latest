...
<head>
    ...
    <title>TrekLine | Hotel Bookings</title>
...
<body>
    ...
    <h1 style="color:#333;">TREKLINE HOTEL BOOKINGS</h1>
        ...
        <table>
            ...
            $query = "SELECT name, num, email,chkin,chkout,day,persons, price, booking_id,booking_date,status FROM hotels WHERE name = '$username'";
        ...
        <a class="button" href="hotelbooking.html">Book a Hotel</a>
